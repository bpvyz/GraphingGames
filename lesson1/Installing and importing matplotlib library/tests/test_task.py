...
class TestDataProcessing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.genre_counts_reindexed = None
        cls.platform_order = None
        cls.filter_list = ['PS4', 'XOne', 'PC', 'WiiU']

        try:
            from task import df, filtered_df, filter_list, genre_counts, genre_counts_reindexed, platform_order
            cls.df = df
            cls.filtered_df = filtered_df
            cls.filter_list = filter_list
            cls.genre_counts = genre_counts
            cls.genre_counts_reindexed = genre_counts_reindexed
            cls.platform_order = platform_order
    ...
    def test_matplotlib_import(self):
        try:
            ...
            self.assertTrue(True, "Matplotlib is installed.")
        except ImportError:
    ...
    def test_genre_counts_order(self):
        ...
        expected_platform_order = ['PS4', 'XOne', 'PC', 'WiiU']
        actual_platform_order = self.platform_order
        self.assertListEqual(actual_platform_order, expected_platform_order,
                             msg=f"platform_order should be {expected_platform_order} but got {actual_platform_order}")
